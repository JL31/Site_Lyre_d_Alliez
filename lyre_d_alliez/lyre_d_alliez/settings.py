...
"""
    Django settings for lyre_d_alliez project.
...
ROOT_URLCONF = 'lyre_d_alliez.urls'
...
WSGI_APPLICATION = 'lyre_d_alliez.wsgi.application'
...
DATE_INPUTS_FORMATS = ["%d-%m-%Y", "%d/%m/%Y"]
